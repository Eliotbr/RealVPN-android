...
import net.realvpn.android.manager.BuildConfig;
import net.realvpn.android.manager.MainActivity;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    private static final String RESUME_VPN = "net.realvpn.android.manager.RESUME_VPN";
    ...
    private void showNotification(final String msg, String tickerText, @NonNull String channel, long when, ConnectionStatus status) {
        ...
        if (mProfile != null)
            nbuilder.setContentTitle(getString(R.string.notifcation_title, mProfile.mConnections[0].mServerName, mProfile.mUsername));
